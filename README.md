...
```javascript
import { AccessorArray, accessorGetter, accessorSetter, accessors, arraylike2object, assert, cartesianPower, cartesianProduct, cartesianSquare, copy, copyIndexed, filled, filled2d, filled2dBy, filled3d, filled4d, filled5d, filledBy, flatten, flatten2d, flatten2dBy, flatten3d, flatten3dBy, flatten4d, flatten4dBy, flatten5d, flatten5dBy, getter, incrspace, last, linspace, logspace, nCartesianProduct, ones, ones2d, setter, take, toAccessorArray, unitspace, zeroTo, zeros, zeros2d } from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base@esm/index.mjs';
```
