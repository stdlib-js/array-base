...
```javascript
import { AccessorArray, accessorGetter, accessorSetter, accessors, arraylike2object, assert, cartesianPower, cartesianProduct, cartesianSquare, copy, copyIndexed, filled, filledBy, getter, incrspace, linspace, logspace, nCartesianProduct, ones, setter, take, toAccessorArray, unitspace, zeroTo, zeros } from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base@esm/index.mjs';
```
